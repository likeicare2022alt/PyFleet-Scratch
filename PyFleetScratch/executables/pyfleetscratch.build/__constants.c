...
PyObject *global_constants[106] = {0};
...
static void _createGlobalConstants(PyThreadState *tstate) {
...
#else
        getStandaloneSysExecutablePath(global_constants[105])
#endif
    );
    ...
    PyStructSequence_SET_ITEM(Nuitka_dunder_compiled_value, 1, Nuitka_PyInt_FromLong(8));
