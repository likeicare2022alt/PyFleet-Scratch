...
That will install all packages listed in the `uv.lock` file.\
Now run this command `setx HF_API_KEY your_api_key` (THIS IS NOT REQUIRED IF YOU DO NOT WANT TO USE AI).
...
## Installation Script
If you don't want to do all of that I have made an installation script, download it [here](https://github.com/G1aD05/PyFleet-Scratch/install.sh) (Only works on Unix systems right now)
